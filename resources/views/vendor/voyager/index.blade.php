        ...
        <div class="panel-body">
            <div style="position:relative;">
                <ul class="nav nav-pills mt_buttons" role="tablist">
                    <li class="mt_pills active" data-toggle="tab" role="tab" aria-controls="nav-today"
                        id="nav-today-tab"><a href="#nav-today">Now</a></li>
                    <li class="mt_pills" data-toggle="tab" role="tab" aria-controls="nav-yesterday"
                        id="nav-yesterday-tab"><a href="#nav-yesterday">Yesterday</a></li>
                </ul>
                <nav id="ctabs" class="ctabs" style="display:none">
                    <ul class="nav nav-tabs" id="continents_buttons">
                        <li class="mt_pills mt_pills_c active" id="nav-all-tab" data-toggle="pill" href="#nav-all"
                            role="tab" aria-controls="nav-all" aria-selected="true"><a href="#c-all&quot;">All</a></li>
                        <li class="mt_pills mt_pills_c" id="nav-europe-tab" data-toggle="pill" href="#nav-europe"
                            role="tab" aria-controls="nav-all" aria-selected="true"><a href="#c-europe&quot;">Europe</a>
                        </li>
                        <li class="mt_pills mt_pills_c" id="nav-na-tab" data-toggle="pill" href="#nav-na" role="tab"
                            aria-controls="nav-all" aria-selected="true"><a href="#c-north-america&quot;">North
                                America</a></li>
                        <li class="mt_pills mt_pills_c" id="nav-asia-tab" data-toggle="pill" href="#nav-asia" role="tab"
                            aria-controls="nav-all" aria-selected="true"><a href="#c-asia&quot;">Asia</a></li>
                        <li class="mt_pills mt_pills_c" id="nav-sa-tab" data-toggle="pill" href="#nav-sa" role="tab"
                            aria-controls="nav-all" aria-selected="true"><a href="#c-south-america&quot;">South
                                America</a></li>
                        <li class="mt_pills mt_pills_c" id="nav-africa-tab" data-toggle="pill" href="#nav-africa"
                            role="tab" aria-controls="nav-all" aria-selected="true"><a href="#c-africa&quot;">Africa</a>
                        </li>
                        <li class="mt_pills mt_pills_c" id="nav-oceania-tab" data-toggle="pill" href="#nav-oceania"
                            role="tab" aria-controls="nav-all" aria-selected="true"><a
                                href="#c-oceania&quot;">Oceania</a></li>
                    </ul>
                </nav>
            </div>
            @php
            ...
            //echo $crawler->filter('#nav-tabContent')->html();
            @endphp
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //custom
        $('#nav-yesterday').hide();
        $("#nav-today-tab").click(function(){
            $('#nav-yesterday').hide();
            $('#nav-today').show();
        });
        $("#nav-yesterday-tab").click(function(){
            $('#nav-yesterday').show();
            $('#nav-today').hide();
        });
        //end custom
